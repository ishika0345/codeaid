  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        {/*title*/}
        <h1 className='text-3xl font-bold text-slate-900 mb-2'>Create Gist</h1>
        <p className='text-slate-600'>Share your Knowledge with the world!</p>
      </div>
      {/*form*/}
      <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4 ml-5'>
        {/*Header*/}
            ...
            images.length > 0 && <div>
              {
                images.length>0&&<div className='flex flex-wrap gap-2 mt-4 '>
                  ...
                  <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
                    ...
                    <button disabeled={loading} onClick={()=>toast.promise(handleSubmit(),
                    {
                      loading: 'uploading...',
                      success: <p>Gist Published Successfully!</p>,
                       error: <p>Gist Not Added</p>,
