...
const Connection = () => {
  ...
  return (
     ...
     <div className='h-70 bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
            ...
            <div className='mb-8 flex flex-wrap gap-6'>
              ...
              <div className='inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm'>
                {
                    dataArray.map((tab)=>(
                        <button onClick={()=>setcurrentTab(tab.label)} key={tab.label} className={`flex items-center px-3 py-1 cursor-pointer text-sm rounded-md transition-colors${currentTab === tab.label? 'bg-white font-medium text-black':'text-gray-300 hover:text-black'}`}>
        ...
        {/*connection*/}
        <div className='w-screen sm:w-[calc(100vw-240px)] no-scrollbar overflow-x-auto px-4 flex gap-6 mt-6 '>
